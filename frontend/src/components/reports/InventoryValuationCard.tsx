      ...
      <div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 border border-[#262626] rounded-lg bg-[#141414] flex items-center gap-4">
            ...
            <div>
              <div className="text-sm text-gray-400 mb-1">الوزن الإجمالي</div>
              <div className="text-2xl font-bold font-mono text-white">
                {Number(valuation.total_weight).toLocaleString("en-AE", { minimumFractionDigits: 3, maximumFractionDigits: 3 })} <span className="text-sm font-sans text-gray-500">جم</span>
              </div>
            </div>
          </div>
        </div>
